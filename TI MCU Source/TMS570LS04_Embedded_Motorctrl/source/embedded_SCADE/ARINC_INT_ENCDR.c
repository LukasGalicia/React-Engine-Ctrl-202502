...
void ARINC_INT_ENCDR(inC_ARINC_INT_ENCDR *inC, outC_ARINC_INT_ENCDR *outC)
{
  ...
  outC->_L14 = inC->DATA;
  /* _L15=(Int_data_bmask#1)/ */
  Int_data_bmask(outC->_L14, &outC->Context_Int_data_bmask_1);
  outC->_L15 = outC->Context_Int_data_bmask_1.outdata;
  outC->_L5 = inC->LABEL;
  ...
  outC->_L2 = outC->_L7 | outC->_L4 | outC->_L15 | outC->_L10 | outC->_L13;
...
void ARINC_INT_ENCDR_init(outC_ARINC_INT_ENCDR *outC)
{
  ...
  /* _L15=(Int_data_bmask#1)/ */
  Int_data_bmask_init(&outC->Context_Int_data_bmask_1);
}
...
{
  /* _L15=(Int_data_bmask#1)/ */
  Int_data_bmask_reset(&outC->Context_Int_data_bmask_1);
}
